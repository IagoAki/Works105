        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Cadastrar Oferta</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th><input class="btn btn-success" type="submit" name="Cadastrar" value="Cadastrar"></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                               <tr>
                                                    <td><a href="/minhasala/pages/mapa.php">Analise e Desenvolvimento de Sistema</a></td>
                                                    <td>1º Semestre</td>
                                                    <td>Manhã</td>
                                                    <td>1</td>
                                                    <td>CDL For</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>1</td>
                                                    <td>CDL For</td>
                                                     <th>   <input class="btn btn-primary" type="submit" name="Editar" value="Editar">
                                                    <input class="btn btn-danger" type="submit" name="Excluir" value="Excluir">
                                                    </th>
                                                </tr>
                                            </tbody>
